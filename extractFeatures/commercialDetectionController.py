...
import calculateMVL as mvl
import calculateECR as ECR
import calculateDiff as farbchange
import calculateSIFT as SR
...
#BRIGHTNESS_EDGE = 190
BRIGHTNESS_LIMIT = 210
BRIGHTNESS_BOOLEAN= False
CONSECUTIVE_COOLDOWN = 10
